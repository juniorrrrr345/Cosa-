...
cloudinary.config({
  cloud_name: process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME || 'dtjab1akq',
  api_key: process.env.NEXT_PUBLIC_CLOUDINARY_API_KEY || '851324984197634',
  api_secret: process.env.CLOUDINARY_API_SECRET || 'bQJrdNdhts56XuPx4uCoWEme80g',
});
