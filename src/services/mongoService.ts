...
class MongoService {
  ...
  private async connect(): Promise<void> {
    ...
    try {
      ...
      const uri = process.env.MONGODB_URI || 'mongodb+srv://bipcosa06admin:BiP2024Secure%21@cluster0.itciznm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
